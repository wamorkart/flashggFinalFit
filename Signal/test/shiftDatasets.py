...
parser = OptionParser(option_list=[
   ...
   # make_option("--inp-names",type='string',dest='inp_names',default='GluGluToHHTo2B2G_node_SM_13TeV_madgraph'),
    make_option("--inp-dir",type='string',dest="inp_dir",default='/afs/cern.ch/work/n/nchernya/ETH/CMSSW_8_0_28/src/flashgg/workspacesSignalSingleHiggs/'),
    make_option("--out-dir",type='string',dest="out_dir",default='/afs/cern.ch/work/n/nchernya/ETH/CMSSW_8_0_28/src/flashgg/workspacesSignalSingleHiggs/scaled/'),
