...
parser = OptionParser(option_list=[
   ...
   # make_option("--target-names",type='string',dest='target_names',default='ttHToGG_M125_13TeV_powheg_pythia8_v2,GluGluHToGG_M-125_13TeV_powheg_pythia8,VBFHToGG_M-125_13TeV_powheg_pythia8'),
    make_option("--inp-files",type='string',dest='inp_files',default='ttHToGG_M125_13TeV_powheg_pythia8,GluGluHToGG_M-125_13TeV_powheg_pythia8,VBFHToGG_M125_13TeV_amcatnlo_pythia8,VHToGG_M125_13TeV_amcatnloFXFX_madspin_pythia8,GluGluToHHTo2B2G_node_SM_13TeV-madgraph'),
   ...
   # make_option("--inp-names",type='string',dest='inp_names',default='GluGluToHHTo2B2G_node_SM_13TeV_madgraph'),
    ...
    make_option("--out-dir",type='string',dest="out_dir",default='/afs/cern.ch/work/n/nchernya/ETH/DiHiggs/root_file/13_12_2018/renamed2017/'),
